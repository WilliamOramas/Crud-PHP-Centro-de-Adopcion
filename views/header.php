...
<?php if (isset($_GET['msj'])): 
    ...
    $esError = ($tipo === 'error');
    $colorClase = $esError ? 'red-500' : 'brand-green';
?>
    <div class="fixed top-4 left-0 right-0 z-50 px-4">
        <div id="notificacion-msj" class="max-w-md mx-auto bg-white border-l-4 border-<?= $colorClase ?> shadow-xl p-4 rounded-r-lg" style="transition: opacity 0.5s ease;">
            <div class="flex items-center">
                <div class="py-1 text-<?= $colorClase ?>">
                ...
                <div>
                    <p class="font-bold text-brand-dark"><?= $esError ? 'Error' : 'Notificación' ?></p>
